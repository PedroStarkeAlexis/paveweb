// src/features/calculadora/components/telas/TelaDesempenhoEtapa3.jsx
...
function TelaDesempenhoEtapa3({ onChange, values, errors, onNextStep, isNextStepDisabled, nextStepText }) {
  const etapaNumero = 3;
...
export default TelaDesempenhoEtapa3;