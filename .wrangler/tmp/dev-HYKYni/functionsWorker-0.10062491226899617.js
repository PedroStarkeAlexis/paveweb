...
// .wrangler/tmp/pages-CscUhd/functionsWorker-0.10062491226899617.mjs
...
__name2(contentEmbeddingFromMldev$1, "contentEmbeddingFromMldev$1");
...
__name2(functionCallFromMldev$2, "functionCallFromMldev$2");
...
__name2(inlinedEmbedContentResponseFromMldev, "inlinedEmbedContentResponseFromMldev");
...
__name2(singleEmbedContentResponseFromMldev, "singleEmbedContentResponseFromMldev");
...
__name2(toolComputerUseToMldev$4, "toolComputerUseToMldev$4");
...
__name2(functionCallToVertex$2, "functionCallToVertex$2");
...
__name2(toolComputerUseToMldev$3, "toolComputerUseToMldev$3");
...
__name2(toolComputerUseToVertex$2, "toolComputerUseToVertex$2");
...
__name2(functionCallFromMldev$1, "functionCallFromMldev$1");
...
__name2(functionCallFromVertex$1, "functionCallFromVertex$1");
...
__name2(functionCallToVertex$1, "functionCallToVertex$1");
...
__name2(toolComputerUseToMldev$2, "toolComputerUseToMldev$2");
...
__name2(toolComputerUseToVertex$1, "toolComputerUseToVertex$1");
...
__name2(entityLabelFromVertex, "entityLabelFromVertex");
...
__name2(functionCallToVertex, "functionCallToVertex");
...
__name2(toolComputerUseToMldev$1, "toolComputerUseToMldev$1");
...
__name2(toolComputerUseToVertex, "toolComputerUseToVertex");
...
__name2(toolComputerUseToMldev, "toolComputerUseToMldev");
...
__name(createTextPreview, "createTextPreview");
__name2(createTextPreview, "createTextPreview");
var INTENT_ROUTER_SCHEMA = {
  type: Type.OBJECT,
  properties: {
    intent: {
      type: Type.STRING,
      description: "A inten\xE7\xE3o detectada do usu\xE1rio",
      enum: ["BUSCAR_QUESTAO", "CRIAR_QUESTAO", "CRIAR_FLASHCARDS", "INFO_PAVE", "CONVERSAR"]
    },
    entities: {
      type: Type.OBJECT,
      description: "Entidades extra\xEDdas da mensagem do usu\xE1rio",
      properties: {
        materia: {
          type: Type.STRING,
          description: "Mat\xE9ria mencionada (ex: Hist\xF3ria, Qu\xEDmica, Biologia)",
          nullable: true
        },
        topico: {
          type: Type.STRING,
          description: "T\xF3pico espec\xEDfico mencionado",
          nullable: true
        },
        ano: {
          type: Type.INTEGER,
    ...
    questionCount: {
      type: Type.INTEGER,
      description: "N\xFAmero de quest\xF5es solicitadas (se aplic\xE1vel). Default: 1",
      nullable: true
    },
    reasoning: {
      type: Type.STRING,
      description: "Breve explica\xE7\xE3o sobre a decis\xE3o tomada"
    }
  },
  required: ["intent", "reasoning"],
  propertyOrdering: ["intent", "entities", "questionCount", "reasoning"]
};
function createIntentRouterPrompt(history, userQuery) {
  return `Voc\xEA \xE9 um assistente especialista em classificar inten\xE7\xF5es de usu\xE1rios do PAVE UFPel.

**Hist\xF3rico da Conversa:**
${JSON.stringify(history.slice(-5), null, 2)}

**\xDAltima mensagem do usu\xE1rio:**
"${userQuery}"

**Sua Tarefa:**
Analise a mensagem do usu\xE1rio e determine:

1. **Intent (inten\xE7\xE3o principal):**
   - BUSCAR_QUESTAO: Usu\xE1rio quer ver quest\xF5es EXISTENTES do banco de dados
   - CRIAR_QUESTAO: Usu\xE1rio pede explicitamente para GERAR/CRIAR novas quest\xF5es
   - CRIAR_FLASHCARDS: Usu\xE1rio pede para criar flashcards de estudo
   - INFO_PAVE: Usu\xE1rio pergunta sobre o PAVE (regras, datas, funcionamento)
   - CONVERSAR: Conversa geral, sauda\xE7\xE3o, ou pergunta que n\xE3o se encaixa nas anteriores

2. **Entities (entidades):**
   - materia: Nome da mat\xE9ria mencionada (ex: "Hist\xF3ria", "Qu\xEDmica")
   - topico: T\xF3pico espec\xEDfico (ex: "Guerra Fria", "Fotoss\xEDntese")
   - ano: Ano mencionado (ex: 2024)

3. **questionCount:** Se o usu\xE1rio pedir M\xDALTIPLAS quest\xF5es (ex: "crie 3 quest\xF5es", "v\xE1rias quest\xF5es"), extraia o n\xFAmero. Caso contr\xE1rio, use null.

**Regras Importantes:**
- Se o usu\xE1rio pedir "uma quest\xE3o sobre X" SEM mencionar "criar" ou "gerar", classifique como BUSCAR_QUESTAO
- S\xF3 classifique como CRIAR_QUESTAO se houver palavras como: "criar", "gerar", "fazer", "elaborar", "monte"
- Para CRIAR_QUESTAO, se n\xE3o houver n\xFAmero expl\xEDcito, deixe questionCount como null (ser\xE1 tratado como 1)

Responda com um objeto JSON seguindo o schema fornecido.`;
}
__name(createIntentRouterPrompt, "createIntentRouterPrompt");
__name2(createIntentRouterPrompt, "createIntentRouterPrompt");
...
var QUESTION_SCHEMA = {
  ...
  properties: {
    id: {
      type: Type.STRING,
      description: "ID tempor\xE1rio da quest\xE3o gerada"
    },
    materia: {
      type: Type.STRING,
      description: "Mat\xE9ria da quest\xE3o"
    },
    topico: {
      type: Type.STRING,
      description: "T\xF3pico espec\xEDfico da quest\xE3o"
    },
    texto_questao: {
      type: Type.STRING,
      description: "Enunciado completo da quest\xE3o (pode usar Markdown)"
    },
    alternativas: {
      type: Type.ARRAY,
    ...
    referencia: {
      type: Type.STRING,
      description: "Refer\xEAncia da quest\xE3o (sempre 'Gerado por IA')"
    }
  },
...
var QUESTION_GENERATION_SCHEMA = {
  type: Type.OBJECT,
  properties: {
    questions: {
      type: Type.ARRAY,
      description: "Array de quest\xF5es geradas",
...
var FLASHCARD_SCHEMA = {
  ...
  properties: {
    id: {
      type: Type.STRING,
      description: "ID tempor\xE1rio do flashcard"
    },
    term: {
      type: Type.STRING,
    ...
    definition: {
      type: Type.STRING,
      description: "Defini\xE7\xE3o ou explica\xE7\xE3o do termo"
    }
  },
  required: ["id", "term", "definition"],
  propertyOrdering: ["id", "term", "definition"]
};
var FLASHCARD_GENERATION_SCHEMA = {
  type: Type.OBJECT,
  properties: {
    flashcards: {
      type: Type.ARRAY,
...
var QUESTION_RERANKING_SCHEMA = {
  type: Type.OBJECT,
  properties: {
    selected_question_ids: {
      type: Type.ARRAY,
      description: "IDs das quest\xF5es selecionadas como relevantes",
      items: {
        type: Type.STRING
      }
    },
    reasoning: {
      type: Type.STRING,
      description: "Breve explica\xE7\xE3o da sele\xE7\xE3o feita"
    }
  },
  required: ["selected_question_ids"],
  propertyOrdering: ["selected_question_ids", "reasoning"]
};
function createQuestionGenerationPromptV2(materia, topico, count = 1) {
  let subjectSpecificInstructions = "";
  switch (materia) {
    case "Hist\xF3ria":
      subjectSpecificInstructions = "A quest\xE3o deve focar em contextos hist\xF3ricos, an\xE1lise de per\xEDodos, causas e consequ\xEAncias de eventos. Se citar documentos, use o formato de cita\xE7\xE3o em Markdown.";
      break;
    case "Qu\xEDmica":
      subjectSpecificInstructions = "A quest\xE3o deve ser conceitual ou envolver c\xE1lculos simples. Use a formata\xE7\xE3o do Markdown para f\xF3rmulas qu\xEDmicas (ex: H\u2082O) e equa\xE7\xF5es.";
      break;
    case "Biologia":
      subjectSpecificInstructions = "A quest\xE3o deve abordar processos biol\xF3gicos, estruturas, fun\xE7\xF5es ou conceitos ecol\xF3gicos. Use negrito para destacar termos cient\xEDficos chave.";
      break;
    case "F\xEDsica":
      subjectSpecificInstructions = "A quest\xE3o pode envolver conceitos te\xF3ricos ou c\xE1lculos. Use Markdown para f\xF3rmulas e equa\xE7\xF5es quando necess\xE1rio.";
      break;
    case "Matem\xE1tica":
      subjectSpecificInstructions = "A quest\xE3o deve testar racioc\xEDnio matem\xE1tico. Use Markdown para f\xF3rmulas e express\xF5es matem\xE1ticas.";
      break;
    default:
      subjectSpecificInstructions = "A quest\xE3o deve ser clara, objetiva e bem formulada, seguindo o estilo do PAVE UFPel.";
  }
  return `Voc\xEA \xE9 um especialista em elaborar quest\xF5es para o PAVE UFPel.

**Sua Tarefa:**
Gere ${count} quest\xE3o(\xF5es) de m\xFAltipla escolha (A-E) com as seguintes especifica\xE7\xF5es:

**Mat\xE9ria:** ${materia}
**T\xF3pico:** ${topico}
**Quantidade:** ${count} quest\xE3o(\xF5es)

**Instru\xE7\xF5es Espec\xEDficas da Mat\xE9ria:**
...
- Use Markdown para formata\xE7\xE3o quando apropriado
- Estilo PAVE UFPel: quest\xF5es que testem racioc\xEDnio e conhecimento

**Importante:**
- Cada quest\xE3o deve ter um ID tempor\xE1rio \xFAnico (ex: "gen-${Date.now()}-1")
- O campo 'referencia' deve ser sempre "Gerado por IA"
- Gere quest\xF5es IN\xC9DITAS e variadas

Retorne um objeto JSON seguindo o schema fornecido.`;
}
__name(createQuestionGenerationPromptV2, "createQuestionGenerationPromptV2");
__name2(createQuestionGenerationPromptV2, "createQuestionGenerationPromptV2");
function createFlashcardGenerationPrompt(topico, count = 5) {
  return `Voc\xEA \xE9 um especialista em criar materiais de estudo para o PAVE UFPel.

**Sua Tarefa:**
Crie ${count} flashcards de estudo sobre o seguinte t\xF3pico:

**T\xF3pico:** ${topico}

**Instru\xE7\xF5es:**
- Cada flashcard deve ter um TERMO/CONCEITO conciso e uma DEFINI\xC7\xC3O clara
- As defini\xE7\xF5es devem ser diretas, f\xE1ceis de memorizar, mas completas
- Foque nos conceitos mais importantes do t\xF3pico
- Varie entre termos, conceitos, processos e fatos relevantes
- Mantenha um tom educativo e apropriado para estudantes

**Formato:**
- Cada flashcard deve ter um ID tempor\xE1rio \xFAnico (ex: "fc-${Date.now()}-1")
- O termo deve ser curto e direto
- A defini\xE7\xE3o deve ser clara e informativa (1-3 frases)

Retorne um objeto JSON seguindo o schema fornecido.`;
}
__name(createFlashcardGenerationPrompt, "createFlashcardGenerationPrompt");
__name2(createFlashcardGenerationPrompt, "createFlashcardGenerationPrompt");
function createQuestionReRankingPromptV2(userQuery, candidateQuestions, entities) {
  ...
  let contextMessage = `Query do usu\xE1rio: "${userQuery}"`;
  if (entities) {
    const entityParts = [];
    if (entities.materia) entityParts.push(`Mat\xE9ria: '${entities.materia}'`);
    if (entities.topico) entityParts.push(`T\xF3pico: '${entities.topico}'`);
...
Entidades detectadas: ${entityParts.join(", ")}`;
  ...
  return `Voc\xEA \xE9 um especialista em selecionar quest\xF5es relevantes do banco de dados do PAVE UFPel.

**Contexto:**
${contextMessage}

**Quest\xF5es Candidatas (pr\xE9-filtradas):**
${JSON.stringify(simplifiedQuestions, null, 2)}

**Sua Tarefa:**
1. Analise a query do usu\xE1rio e as entidades detectadas
2. Compare com as quest\xF5es candidatas fornecidas
3. Selecione TODAS as quest\xF5es que s\xE3o relevantes para o pedido do usu\xE1rio
4. Voc\xEA pode selecionar uma, v\xE1rias ou nenhuma quest\xE3o

**Crit\xE9rios de Sele\xE7\xE3o:**
- Relev\xE2ncia com o t\xF3pico/mat\xE9ria solicitados
- Adequa\xE7\xE3o ao contexto da pergunta
- Se houver d\xFAvida, INCLUA a quest\xE3o (\xE9 melhor mostrar mais que menos)

Retorne um objeto JSON com os IDs selecionados seguindo o schema fornecido.`;
}
__name(createQuestionReRankingPromptV2, "createQuestionReRankingPromptV2");
__name2(createQuestionReRankingPromptV2, "createQuestionReRankingPromptV2");
function createBasicAuthHeader(user, password) {
  const credentials = `${user}:${password}`;
  return `Basic ${btoa(credentials)}`;
}
__name(createBasicAuthHeader, "createBasicAuthHeader");
__name2(createBasicAuthHeader, "createBasicAuthHeader");
async function fetchFromUploader(path, env) {
  ...
  if (!baseUrl || !adminPassword) {
    throw new Error("Configura\xE7\xE3o do uploader ausente.");
  }
  const headers = new Headers({
...
__name(fetchFromUploader, "fetchFromUploader");
__name2(fetchFromUploader, "fetchFromUploader");
async function fetchAllQuestions(env) {
  ...
  const allQuestionPromises = provaNames.map(
    (name) => fetchFromUploader(`/admin/prova/${encodeURIComponent(name)}`, env).then((res) => {
...
__name(fetchAllQuestions, "fetchAllQuestions");
__name2(fetchAllQuestions, "fetchAllQuestions");
async function callGeminiAPI({
  ...
  const response = await genAIInstance.models.generateContent({
    model: modelName,
    contents: promptText,
    // String é aceita diretamente
    config: Object.keys(config).length > 0 ? config : void 0
  });
  if (!response) {
    throw new Error(`Resposta da API Gemini (${callType}) inv\xE1lida.`);
  }
...
function extractTextFromResponse(response, callType = "generica") {
...
__name(extractTextFromResponse, "extractTextFromResponse");
__name2(extractTextFromResponse, "extractTextFromResponse");
var VECTORIZE_TOP_K = 15;
var MIN_SCORE_THRESHOLD = 0.65;
var FAST_MODEL = "gemini-2.5-flash";
var CREATIVE_MODEL = "gemini-2.5-flash";
async function onRequestPost(context) {
  ...
  try {
    ...
    try {
      ...
      return new Response(
        JSON.stringify({ error: "Requisi\xE7\xE3o JSON inv\xE1lida." }),
        { status: 400 }
      );
    }
    if (!env.GEMINI_API_KEY || !env.QUESTIONS_INDEX || !env.AI) {
      throw new Error(
        "Bindings GEMINI_API_KEY, QUESTIONS_INDEX ou AI n\xE3o configurados."
      );
    }
    const history = requestData?.history;
    if (!Array.isArray(history) || history.length === 0) {
      return new Response(
        JSON.stringify({ error: "Hist\xF3rico inv\xE1lido ou vazio." }),
        { status: 400 }
      );
    }
    ...
    if (!userQuery) {
      return new Response(
        JSON.stringify({ error: "Query do usu\xE1rio inv\xE1lida no hist\xF3rico." }),
        { status: 400 }
      );
    }
    ...
    console.log(`[LOG] ${functionName}: FASE 1 - Chamando Router de Inten\xE7\xF5es`);
    ...
    try {
      ...
      console.error(
        `[ERRO] ${functionName}: Falha no Router de Inten\xE7\xF5es:`,
        error
      );
      return new Response(
        JSON.stringify({
    ...
    try {
      ...
      console.log(`[LOG] ${functionName}: Router Text extra\xEDdo:`, routerText);
      ...
      return new Response(
        JSON.stringify({
          commentary: "N\xE3o consegui entender a resposta interna. Tente reformular.",
          questions: []
        }),
        { status: 500 }
      );
    ...
    console.log(
      `[LOG] ${functionName}: FASE 2 - Executando a\xE7\xE3o para intent: ${intent}, Reasoning: ${reasoning}`
    );
    let commentary = "";
    ...
    switch (intent) {
      ...
      case "CRIAR_FLASHCARDS":
        ...
        break;
      case "INFO_PAVE":
        commentary = "Para informa\xE7\xF5es detalhadas sobre o PAVE, consulte a **p\xE1gina de informa\xE7\xF5es** ou o edital mais recente. Posso ajudar com quest\xF5es espec\xEDficas! \u{1F4DA}";
        displayCard = "pave_info_recommendation";
        break;
      case "CONVERSAR":
        commentary = "Ol\xE1! \u{1F44B} Estou aqui para ajudar com quest\xF5es do PAVE. Posso **buscar** quest\xF5es existentes, **criar** novas quest\xF5es, ou gerar **flashcards** de estudo. Como posso ajudar?";
        break;
      default:
        commentary = "N\xE3o entendi bem seu pedido. Posso **buscar** quest\xF5es existentes, **criar** novas quest\xF5es, ou gerar **flashcards** de estudo. O que voc\xEA gostaria?";
    }
    console.log(
      `[LOG] ${functionName}: Retornando - Commentary: "${createTextPreview(
        commentary,
        50
      )}", Quest\xF5es: ${questionsToReturn.length}, Flashcards: ${flashcardsToReturn.length}`
    );
    return new Response(
      JSON.stringify({
...
async function handleSearchQuestion(env, genAI, safetySettings, userQuery, entities) {
  ...
  try {
    ...
    if (isQueryTooVague) {
      return {
        commentary: "Para te ajudar a encontrar quest\xF5es, poderia me dar mais detalhes? Como a mat\xE9ria ou o t\xF3pico. \u{1F60A}",
        questions: []
      };
    }
    ...
    if (!Array.isArray(allQuestionsData) || allQuestionsData.length === 0) {
      return {
        commentary: "Meu banco de quest\xF5es parece estar vazio ou indispon\xEDvel no momento.",
        questions: []
      };
    }
    ...
    try {
      ...
      console.log(
        `[LOG] ${functionName}: Vectorize retornou ${vectorQueryResult.matches.length} correspond\xEAncias.`
      );
      if (vectorQueryResult.matches?.length > 0) {
        highConfidenceMatches = vectorQueryResult.matches.filter(
          (match2) => match2.score >= MIN_SCORE_THRESHOLD
        );
        console.log(
      ...
      return {
        commentary: "Tive um problema com a busca sem\xE2ntica. N\xE3o consigo encontrar quest\xF5es agora.",
        questions: []
      };
    }
    if (highConfidenceMatches.length === 0) {
      return {
        commentary: `N\xE3o encontrei quest\xF5es relevantes para "${createTextPreview(
          userQuery,
          30
    ...
    const candidateIds = highConfidenceMatches.map((match2) => match2.id);
    const candidatesForReRanking = allQuestionsData.filter(
      (q) => candidateIds.includes(q.id.toString())
    );
    console.log(
    ...
    if (!reRankingPrompt) {
      return {
        commentary: "N\xE3o consegui preparar as op\xE7\xF5es para escolher.",
        questions: []
      };
    }
    try {
      ...
      if (reRankingData?.selected_question_ids?.length > 0) {
        const selectedIds = reRankingData.selected_question_ids.map(
          (id) => id.toString()
        );
        const selectedQuestions = allQuestionsData.filter(
          (q) => selectedIds.includes(q.id.toString())
        );
        if (selectedQuestions.length > 0) {
          console.log(
            `[LOG] ${functionName}: IA selecionou ${selectedQuestions.length} quest\xE3o(\xF5es).`
          );
          return {
            commentary: selectedQuestions.length > 1 ? `Encontrei ${selectedQuestions.length} quest\xF5es relevantes:` : "Encontrei esta quest\xE3o:",
            questions: selectedQuestions
          };
        } else {
          return {
            commentary: `Selecionei refer\xEAncias, mas n\xE3o achei as quest\xF5es completas.`,
            questions: []
          };
        }
      } else {
        return {
          commentary: `Analisei as op\xE7\xF5es mais relevantes, mas nenhuma pareceu perfeita para "${createTextPreview(
            userQuery,
            30
          )}". Gostaria que eu criasse uma?`,
          questions: []
      ...
      return {
        commentary: "Tive um problema ao selecionar a melhor quest\xE3o.",
        questions: []
      };
    }
  } catch (error) {
    ...
    return {
      commentary: `Ocorreu um problema ao buscar quest\xF5es: ${error.message}`,
      questions: []
    };
  }
}
__name(handleSearchQuestion, "handleSearchQuestion");
__name2(handleSearchQuestion, "handleSearchQuestion");
async function handleCreateQuestion(genAI, safetySettings, entities, count) {
  ...
  try {
    ...
    console.log(
      `[LOG] ${functionName}: Gerando ${questionCount} quest\xE3o(\xF5es) sobre ${materia} - ${topico}`
    );
    ...
    if (data?.questions && Array.isArray(data.questions) && data.questions.length > 0) {
      const validQuestions = data.questions.map((q, index) => {
        if (!q?.texto_questao || !q.alternativas || !q.resposta_letra) {
          console.warn(
            `[WARN] ${functionName}: Quest\xE3o inv\xE1lida no \xEDndice ${index}:`,
            q
          );
          return null;
        }
      ...
      if (validQuestions.length > 0) {
        return {
          commentary: validQuestions.length > 1 ? `Certo! Elaborei ${validQuestions.length} quest\xF5es para voc\xEA:` : "Certo! Elaborei esta quest\xE3o para voc\xEA:",
          questions: validQuestions
        };
      }
    }
    return {
      commentary: "Tentei criar as quest\xF5es, mas os dados n\xE3o vieram no formato esperado. \u{1F625}",
      questions: []
    };
  } catch (error) {
    console.error(`[ERRO] ${functionName}: Erro ao criar quest\xE3o:`, error);
    return {
      commentary: `N\xE3o consegui criar a quest\xE3o: ${error.message}`,
      questions: []
    };
  }
}
__name(handleCreateQuestion, "handleCreateQuestion");
__name2(handleCreateQuestion, "handleCreateQuestion");
async function handleCreateFlashcards(genAI, safetySettings, entities, count) {
  ...
  try {
    ...
    const flashcardCount = Math.min(Math.max(count || 5, 3), 10);
    console.log(
    ...
    if (data?.flashcards && Array.isArray(data.flashcards) && data.flashcards.length > 0) {
      const validFlashcards = data.flashcards.map((fc, index) => {
        if (!fc?.term || !fc.definition) {
          console.warn(
            `[WARN] ${functionName}: Flashcard inv\xE1lido no \xEDndice ${index}:`,
            fc
          );
          return null;
        }
    ...
    return {
      commentary: "Tentei criar os flashcards, mas os dados n\xE3o vieram no formato esperado. \u{1F625}",
      flashcards: []
    };
  } catch (error) {
    console.error(`[ERRO] ${functionName}: Erro ao criar flashcards:`, error);
    return {
      commentary: `N\xE3o consegui criar os flashcards: ${error.message}`,
      flashcards: []
    };
  }
}
__name(handleCreateFlashcards, "handleCreateFlashcards");
__name2(handleCreateFlashcards, "handleCreateFlashcards");
...
async function onRequestPost2(context) {
  try {
    ...
    if (!topic || typeof topic !== "string" || topic.trim().length === 0) {
      return new Response(JSON.stringify({ error: "O t\xF3pico \xE9 inv\xE1lido ou n\xE3o foi fornecido." }), {
        status: 400,
        headers: { "Content-Type": "application/json" }
      });
    }
    const prompt = `Crie exatamente 5 flashcards concisos sobre o t\xF3pico "${topic}". Para cada flashcard, forne\xE7a um "term" (o conceito principal em poucas palavras) e uma "definition" (uma explica\xE7\xE3o clara e direta em no m\xE1ximo 2-3 frases). Retorne os resultados como um array JSON dentro de um objeto, com a chave "flashcards". Exemplo de formato: {"flashcards":[{"term":"Exemplo","definition":"Este \xE9 um exemplo."}]}`;
    ...
    if (!geminiResponse.ok) {
      ...
      return new Response(JSON.stringify({ error: "Falha ao comunicar com o servi\xE7o de IA." }), {
...
async function onRequestGet2(context) {
  const { env } = context;
  try {
    console.log("[get-filter-options] Carregando todas as quest\xF5es do uploader...");
    const allQuestions = await fetchAllQuestions(env);
    if (!allQuestions || allQuestions.length === 0) {
      console.error("[get-filter-options] Nenhuma quest\xE3o encontrada no uploader.");
      return new Response(JSON.stringify({ anos: [], materias: [], etapas: [] }), {
        status: 404,
        headers: { "Content-Type": "application/json" }
      });
    }
    console.log(`[get-filter-options] ${allQuestions.length} quest\xF5es carregadas.`);
    ...
    console.error("Erro ao buscar op\xE7\xF5es de filtro:", err);
    return new Response(JSON.stringify({ error: "Falha ao carregar op\xE7\xF5es de filtro." }), {
      status: 500,
      headers: { "Content-Type": "application/json" }
    });
  }
...
async function onRequestGet3(context) {
  ...
  if (!geminiApiKey) {
    console.error(
      "[get-models] Erro: GEMINI_API_KEY n\xE3o est\xE1 configurada no ambiente."
    );
    return new Response(
  ...
  try {
    ...
    const filteredModels = data.models.filter(
      (model) => model.supportedGenerationMethods && model.supportedGenerationMethods.includes("generateContent") && // Optional: Add other filters if needed, e.g., excluding specific models
      !model.name.includes("embedding") && !model.name.includes("aqa")
    ).map((model) => ({
    ...
    return new Response(
      JSON.stringify({
        error: `Erro ao processar a requisi\xE7\xE3o: ${error.message}`
      }),
      {
        status: 500,
        headers: { "Content-Type": "application/json" }
...
async function onRequestPost3(context) {
  ...
  if (!vectorIndex || !ai) {
    return new Response(
      JSON.stringify({
        error: "Bindings Vectorize ou AI n\xE3o configurados."
      }),
  ...
  try {
    ...
    const allQuestionsData = await fetchAllQuestions(env);
    console.log(`[DEBUG] fetchAllQuestions retornou: ${allQuestionsData ? allQuestionsData.length : "null/undefined"} quest\xF5es`);
    if (!Array.isArray(allQuestionsData) || allQuestionsData.length === 0) {
      console.error("[ERROR] Nenhuma quest\xE3o retornada. Array?", Array.isArray(allQuestionsData), "Length:", allQuestionsData?.length);
      return new Response(
        JSON.stringify({ error: "Nenhuma quest\xE3o encontrada via API do uploader." }),
    ...
    for (const questao of allQuestionsData) {
      if (!questao || !questao.id) {
        console.warn("Quest\xE3o inv\xE1lida ou sem ID:", questao);
        continue;
      }
      let corpoTexto = "";
      if (Array.isArray(questao.corpo_questao)) {
        console.log(`[DEBUG] Quest\xE3o ${questao.id}: corpo_questao \xE9 array com ${questao.corpo_questao.length} itens`);
        corpoTexto = questao.corpo_questao.filter((item) => item.tipo === "texto").map((item) => item.conteudo).join(" ");
        console.log(`[DEBUG] Quest\xE3o ${questao.id}: texto extra\xEDdo (primeiros 100 chars): "${corpoTexto.substring(0, 100)}..."`);
      } else if (questao.texto_questao) {
        console.log(`[DEBUG] Quest\xE3o ${questao.id}: usando formato legado (texto_questao)`);
        corpoTexto = questao.texto_questao;
      } else {
        console.warn(`[WARN] Quest\xE3o ${questao.id}: sem corpo_questao nem texto_questao`);
      }
      if (!corpoTexto.trim()) {
        console.warn("Quest\xE3o sem corpo de texto:", questao.id);
        continue;
      }
      let alternativasTexto = "";
      if (Array.isArray(questao.alternativas)) {
        alternativasTexto = questao.alternativas.map((alt) => `${alt.letra}: ${alt.texto}`).join(" ");
      }
    ...
    console.log(`[DEBUG] Loop conclu\xEDdo. Total de textos coletados: ${textsForEmbedding.length}`);
    ...
    if (textsForEmbedding.length === 0) {
      ...
      return new Response(
        JSON.stringify({
          error: "Nenhum texto v\xE1lido encontrado nas quest\xF5es.",
          debug: {
    ...
    console.log(
      `Iniciando gera\xE7\xE3o de embeddings para ${textsForEmbedding.length} textos em lotes de ${batchSize}.`
    );
    for (let i = 0; i < textsForEmbedding.length; i += batchSize) {
      ...
      for (let j = 0; j < embeddingVectors.length; j++) {
        if (embeddingVectors[j] && embeddingVectors[j].length > 0) {
          ...
          console.warn(
            `Embedding n\xE3o gerado para quest\xE3o ID: ${metadataBatch[j].questionId} (texto: "${textBatch[j] ? textBatch[j].substring(0, 50) + "..." : "VAZIO"}")`
          );
        }
      }
      if (batchVectorsToInsert.length > 0) {
        ...
        try {
          ...
          console.log(
            `${batchVectorsToInsert.length} vetores inseridos/atualizados no \xEDndice. Total processado: ${processedCount}`
          );
        } catch (upsertError) {
          console.error(
            `Erro ao fazer upsert no lote ${Math.floor(i / batchSize) + 1}:`,
            upsertError.message,
            upsertError.cause ? JSON.stringify(
              upsertError.cause,
    ...
    console.error(
      "Erro GERAL durante a indexa\xE7\xE3o:",
      error.message,
      error.cause ? JSON.stringify(error.cause, Object.getOwnPropertyNames(error.cause)) : "",
...
async function onRequest4(context) {
  if (context.request.method === "POST") {
    return await onRequestPost3(context);
  }
  return new Response(
...
function createBasicAuthHeader2(user, password) {
  const credentials = `${user}:${password}`;
  const encoded = btoa(credentials);
  return `Basic ${encoded}`;
}
__name(createBasicAuthHeader2, "createBasicAuthHeader2");
__name2(createBasicAuthHeader2, "createBasicAuthHeader");
async function fetchFromUploader2(path, env) {
  const baseUrl = "https://pave-uploader.pedroalexis016.workers.dev";
  const adminPassword = "admin123";
  const adminUser = "admin";
  if (!baseUrl || !adminPassword) {
    throw new Error("Configura\xE7\xE3o do uploader ausente. Verifique as vari\xE1veis de ambiente.");
  }
  const headers = new Headers({
    Authorization: createBasicAuthHeader2(adminUser, adminPassword)
  });
...
__name(fetchFromUploader2, "fetchFromUploader2");
__name2(fetchFromUploader2, "fetchFromUploader");
async function onRequestGet4(context) {
  ...
  try {
    if (!provaName) {
      const response2 = await fetchFromUploader2("/admin/provas", env);
      if (!response2.ok) {
        const message = await safeReadError(response2);
        return jsonError(message, response2.status || 502);
      }
      const payload2 = await response2.json();
      return jsonResponse(payload2, 200, { "Cache-Control": "s-maxage=900" });
    }
    const response = await fetchFromUploader2(`/admin/prova/${encodeURIComponent(provaName)}`, env);
    if (response.status === 404) {
      return jsonError("Prova n\xE3o encontrada.", 404);
    }
    if (!response.ok) {
...
__name(safeReadError, "safeReadError");
__name2(safeReadError, "safeReadError");
...
async function onRequestGet5(context) {
  ...
  try {
    ...
    console.log("[DEBUG] Buscando quest\xF5es via fetchAllQuestions...");
    const allQuestionsData = await fetchAllQuestions(env);
    if (!Array.isArray(allQuestionsData)) {
      console.error("[ERROR] fetchAllQuestions n\xE3o retornou array:", allQuestionsData);
      return new Response(
        JSON.stringify({ error: "Formato de dados inv\xE1lido." }),
        { status: 500, headers: { "Content-Type": "application/json" } }
      );
    }
    console.log(`[DEBUG] Total de quest\xF5es recebidas: ${allQuestionsData.length}`);
...
async function onRequest6(context) {
  if (context.request.method === "GET") {
    return await onRequestGet5(context);
  }
  return new Response(
    `M\xE9todo ${context.request.method} n\xE3o permitido. Use GET.`,
    { status: 405 }
...
var EMBEDDING_MODEL2 = "@cf/baai/bge-m3";
var DEFAULT_SEARCH_LIMIT = 100;
var DEFAULT_TOP_K = 25;
var MIN_SCORE_THRESHOLD2 = 0.4;
async function onRequestGet6(context) {
  const { request, env } = context;
  const vectorIndex = env.QUESTIONS_INDEX;
  const ai = env.AI;
  console.log(`[search-questions] Recebida requisi\xE7\xE3o: ${request.url}`);
  if (!vectorIndex || !ai) {
    console.error(
      "[search-questions] ERRO: Bindings Vectorize ou AI n\xE3o configurados."
    );
    return new Response(
      JSON.stringify({
        error: "Bindings Vectorize ou AI n\xE3o configurados."
  ...
  try {
    ...
    console.log(
      `[search-questions] Par\xE2metros: query="${searchQuery}", materia="${filterMateria}", ano="${filterAnoStr}", etapa="${filterEtapaStr}", page=${page}, limit=${limit}`
    );
    let allQuestionsData = null;
    let initialRelevantQuestions = [];
    console.log("[search-questions] Carregando todas as quest\xF5es do uploader...");
    allQuestionsData = await fetchAllQuestions(env);
    if (!Array.isArray(allQuestionsData) || allQuestionsData.length === 0) {
      console.error(
        "[search-questions] ERRO: Nenhuma quest\xE3o foi carregada do uploader."
      );
      throw new Error("Nenhuma quest\xE3o encontrada no reposit\xF3rio de provas.");
    }
    console.log(
      `[search-questions] ${allQuestionsData.length} quest\xF5es carregadas no total.`
    );
    if (searchQuery && searchQuery.trim() !== "") {
      ...
      console.log(
        `[search-questions] Op\xE7\xF5es da consulta Vectorize: ${JSON.stringify(
          searchOptions
        )}`
      );
      ...
      console.log(
        `[search-questions] Vectorize retornou ${vectorQueryResult.matches.length} correspond\xEAncias.`
      );
      if (vectorQueryResult.matches && vectorQueryResult.matches.length > 0) {
        console.log("[DEBUG] Scores de todas as correspond\xEAncias:");
        vectorQueryResult.matches.forEach((match2, idx) => {
          console.log(`  [${idx + 1}] ID: ${match2.id}, Score: ${match2.score.toFixed(4)}`);
        });
      }
      if (vectorQueryResult.matches && vectorQueryResult.matches.length > 0) {
        const highConfidenceMatches = vectorQueryResult.matches.filter(
          (match2) => match2.score >= MIN_SCORE_THRESHOLD2
        );
        console.log(
          `[search-questions] ${highConfidenceMatches.length} correspond\xEAncias com score >= ${MIN_SCORE_THRESHOLD2} (de ${vectorQueryResult.matches.length} iniciais).`
        );
        if (highConfidenceMatches.length > 0) {
          ...
          console.log(
            `[search-questions] IDs das quest\xF5es de alta confian\xE7a: ${JSON.stringify(
              matchedQuestionIds
            )}`
          );
          initialRelevantQuestions = matchedQuestionIds.map(
            (id) => allQuestionsData.find((q) => q.id && q.id.toString() === id)
          ).filter(Boolean);
          console.log(
            `[search-questions] ${initialRelevantQuestions.length} quest\xF5es completas (alta confian\xE7a) encontradas ap\xF3s mapeamento.`
          );
        } else {
          console.log(
            `[search-questions] Nenhuma correspond\xEAncia do Vectorize atingiu o score m\xEDnimo de ${MIN_SCORE_THRESHOLD2}.`
          );
          initialRelevantQuestions = [];
        }
      } else {
        console.log("[search-questions] Nenhuma correspond\xEAncia do Vectorize.");
        initialRelevantQuestions = [];
      }
    } else {
      console.log(
        "[search-questions] Modo: Sem query de busca. Usando todas as quest\xF5es do R2 como base para filtros."
      );
    ...
    if (filterMateria || filterAnoNum || filterEtapaNum) {
      ...
      filteredQuestions = initialRelevantQuestions.filter((q) => {
        ...
        if (filterMateria && q.materia) {
          if (q.materia.trim().toLowerCase() !== filterMateria.trim().toLowerCase()) {
            match2 = false;
          }
        } else if (filterMateria && !q.materia) {
          match2 = false;
        }
        if (match2 && filterAnoNum && q.ano) {
          if (q.ano !== filterAnoNum) {
            match2 = false;
          }
        } else if (match2 && filterAnoNum && !q.ano) {
          match2 = false;
        }
        if (match2 && filterEtapaNum && q.etapa) {
          if (q.etapa !== filterEtapaNum) {
            match2 = false;
          }
        } else if (match2 && filterEtapaNum && !q.etapa) {
          match2 = false;
        }
        return match2;
      });
      console.log(
        `[search-questions] ${filteredQuestions.length} quest\xF5es ap\xF3s filtros manuais.`
      );
    } else {
      console.log(
    ...
    console.log(
      `[search-questions] Pagina\xE7\xE3o: totalItems=${totalItems}, totalPages=${totalPages}, currentPage=${page}, limit=${limit}. Retornando ${questionsForPage.length} quest\xF5es.`
    );
    const responseBody = {
      questions: questionsForPage,
      pagination: {
...
async function onRequest7(context) {
  if (context.request.method === "GET") {
    return await onRequestGet6(context);
  }
  return new Response(`M\xE9todo ${context.request.method} n\xE3o permitido.`, {
    status: 405
  });
...
// .wrangler/tmp/bundle-tzTQeM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-tzTQeM/middleware-loader.entry.ts
...
@google/genai/dist/web/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.10062491226899617.js.map
